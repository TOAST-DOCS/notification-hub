...
| Common | false | 400108 | This domain is already registered. |
| Common | false | 400109 | This domain has not been verified. |
| Common | false | 400110 | This domain is not a root domain. |
| Common | false | 400111 | This domain has already been verified. |
| Common | false | 400112 | A subdomain must not be a root domain. |
| Common | false | 400113 | This subdomain is not registered. |
| Common | false | 400114 | This domain is not registered. |
...
| Common | false | 400119 | The root domain has not been verified. |
| Common | false | 400120 | This domain has already been shared. |
...
| Common | false | 400127 | The domain and the subdomain are the same. |
...
| Common | false | 400202 | This attachment ID has already been used. |
...
| Common | false | 400206 | The recipient number is not on the whitelist. |
| Common | false | 400207 | The conversion rate is below the threshold. |
| Common | false | 400208 | This template ID has already been used. |
| Common | false | 400209 | The maximum number of registered templates has been reached. |
| Common | false | 400210 | This template has been deleted. |
| Common | false | 400211 | Invalid category. |
| Common | false | 400212 | The top-level category cannot be deleted. |
| Common | false | 400213 | This sender number is already registered. |
| Common | false | 400214 | This has already been reviewed. |
| Common | false | 400215 | The review has ended. |
| Common | false | 400216 | This user is already being verified. |
| Common | false | 400217 | This sender number is not registered. |
...
| Common | false | 400304 | This sender profile is already registered. |
...
| Common | false | 400307 | This sender profile group already exists. |
...
| Common | false | 400310 | This sender profile group has already been added. |
| Common | false | 400311 | Invalid SMS opt-out number. |
| Common | false | 400312 | Invalid UUID. |
| Common | false | 400313 | This sender profile has not been added to the group. |
...
| Common | false | 400327 | Content replaced by template parameters cannot exceed 1,000 characters. |
...
| Common | false | 400336 | The template title replaced by template parameters cannot exceed 50 characters. |
...
| Common | false | 400339 | The template header replaced by template parameters cannot exceed 16 characters. |
...
| Common | false | 400345 | Too many buttons when quick replies are requested. |
| Common | false | 400346 | If the template has a web link, linkMo must be entered. |
| Common | false | 400347 | This template code or template name already exists. |
...
| Common | false | 400353 | Replacement parameters cannot be included in button names. |
...
| Common | false | 400356 | Only templates with a status of TSC03 (APPROVE) or TSC04 (REJECT) can be modified. |
...
| Common | false | 400364 | Replacement parameters cannot be included in template additional items. |
...
| Common | false | 400388 | Comments cannot be added to a template with a registered or completed status. |
| Common | false | 400389 | Replacement parameters cannot be included in quick reply names. |
...
| 공통 | false | 400400 | The FriendTalk carousel tail must have a linkMo. |
...
| 공통 | false | 400420 | You can only search within the last 31 days. |
...
| 공통 | false | 400430 | You cannot search for messages older than 90 days. |
| 공통 | false | 400431 | A file upload error occurred. |
...
| 공통 | false | 400436 | You must delete all senders before deactivating the product. |
| 공통 | false | 400437 | Failed to deactivate the dormant template. |
...
| 공통 | false | 400454 | The content contains a prohibited word. |
...
| 공통 | false | 400458 | The type of a method argument does not match the expected type. |
| 공통 | false | 400459 | This version is deprecated. |
| 공통 | false | 400460 | Only the application/json content type is supported. |
| 공통 | false | 400461 | Client error. |
| 공통 | false | 400462 | templateMessageType (AD/MI) must include an AC type button.<br>System error. |
...
| 공통 | false | 400504 | Duplicate certificate. |
...
| 공통 | false | 400508 | The certificate is already complete. |
...
| 공통 | false | 400516 | There is no channel to receive the message. |
...
| 공통 | false | 400600 | The SMS project is deactivated. |
| 공통 | false | 400601 | The SMS project cannot be used. |
| 공통 | false | 400602 | The button parameter is not valid. |
| 공통 | false | 400603 | An unsubscribe number is required for advertising messages. |
| 공통 | false | 400604 | Only one card can be registered for landscape and portrait types. |
...
| 공통 | false | 400619 | Failed to call the unsubscribe list lookup API. |
| 공통 | false | 400620 | Failed to call the unsubscribe list lookup API. |
| 공통 | false | 400621 | Failed to call the sender number lookup API. |
| 공통 | false | 400622 | Failed to call the project lookup API. |
| 공통 | false | 400623 | Failed to call the SMS project activation API. |
| 공통 | false | 400624 | Failed to call the SMS sending API. |
| 공통 | false | 400700 | No identity verification history found. |
| 공통 | false | 404000 | {0} not found.<br>The contact was not found.<br>The recipient was not found.<br>Self-certification was not found.<br>The identity verification record was not found.<br>The content was not found.<br>The attachment was not found.<br>The category was not found.<br>The project was not found.<br>The recipient set was not found.<br>The result of sending to the recipient (messageId: {0}, recipientIndex: {1}) does not exist.<br>Contact sending result (messageId: {0}, recipientIndex: {1}, contactIndex: {2}) does not exist. |
| 공통 | false | 404100 | Failed to retrieve the template. |
| 공통 | false | 404101 | The unsubscribe information was not found. |
...
| 공통 | false | 404219 | The number is not a registered unsubscribe number. |
| 공통 | false | 404220 | The number is not registered. |
| 공통 | false | 404221 | The number is already registered. |
| 공통 | false | 404222 | The unsubscribe number is not registered. |
...
| 공통 | false | 404307 | The template does not have any buttons or quick replies. |
...
| 공통 | false | 404314 | There are no sender profiles registered in your project. |
...
| 공통 | false | 404605 | The unsubscribe list does not exist. |
...
| 공통 | false | 500001 | An internal server error occurred. |
| 공통 | false | 500002 | Invalid status server error. |
| Message sending | false | 400001 | The number of contacts has been exceeded.<br>The flow sending order is empty.<br>The initial sending channel of the flow is empty.<br>The flow sending order is invalid.<br>Duplicate message channel.<br>Unable to add message recipients.<br>Invalid phone number pattern.<br>Invalid email address pattern.<br>Invalid token pattern.<br>{0} is an invalid Alim Talk template status.<br>The email local part length has been exceeded.<br>The email address length has been exceeded.<br>The email domain length has been exceeded.<br>The phone number is empty.<br>The phone number {0} contains a non-numeric value.<br>Invalid phone number. {0}<br>Invalid date format. {0}<br>{0} is an invalid file type.<br>{0} is not supported.<br>Contact sending result lookup fields (messageId: {0}, templateId: {1}, flowId: {2}, statsKeyId: {3}, sender: {4}, contact: {5}) One of them must have a value.<br>The creation date/time start and end must both have values.<br>The creation date/time start must be earlier than the creation date/time end.<br>A message channel is required when a sender is provided.<br>Invalid contact type {1} for message channel {0}.<br>Message recipient set ID and recipient are mutually exclusive.<br>A message recipient set ID or recipient is required.<br>The message recipient set is incomplete.<br>The recipient set is currently invalid.<br>The recipient set type is not a file. {0}<br>The content is empty.<br>The attachment is empty.<br>The Alim Talk template item highlight is empty.<br>The Alim Talk template image URL is empty.<br>The Alim Talk image URL is empty.<br>The body must contain an authentication phrase.<br>A sender key is required for group templates.<br>The Friend Talk wide item list item is empty.<br>The Friend Talk carousel is empty.<br>The type of FriendTalk template you entered can't have coupons.<br>The Friend Talk coupon title is invalid.<br>A category with subcategories cannot be deleted.<br>A category with templates cannot be deleted.<br>The user access key is empty.<br>The SecretKey is empty.<br>The user UUID is empty.<br>The AppKey is empty.<br>The body is empty.<br>The title is empty.<br>The RCS brand ID is empty.<br>The RCS chatbot ID is empty.<br>The RCS chatbot ID is invalid.<br>The RCS unsubscribe number is empty.<br>The RCS body is too long.<br>The RCS title is too long.<br>The RCS MMS type is empty.<br>The RCS message base ID is empty.<br>Too many buttons.<br>The button JSON is invalid.<br>The RCS card is empty.<br>The RCS card size is invalid.<br>The RCS description is empty.<br>The RCS description is too long.<br>The SecretKey could not be found.<br>Not available in {0}. {1}<br>The {0} value is invalid.<br>Unsupported message channel.<br>The length of statsId must be 8 characters or fewer.<br>The sender's ({0}) domain is not authenticated, please authenticate your domain. |
...
| SMS | false | 11902044 | Failed to send the message because international sending is not allowed in the destination country. |
...
| SMS | false | 11902052 | Failed to send the message due to the sending volume limit per organization. |
| SMS | false | 11906001 | Failed to send the message due to opt-out. |
| SMS | false | 12000002 | Failed to send the message due to an error during flow sequential sending processing. |
| SMS | false | 12000003 | Failed to send the message due to an error during message sending preparation. |
...
| SMS | false | 16002000 | Failed to send the message because the sending time limit was exceeded. |
| SMS | false | 16002001 | Failed to send the message due to a wireless network issue. |
| SMS | false | 16002002 | Failed to send the message because it was not delivered from the wireless network to the device. |
...
| SMS | false | 16003000 | Failed to send the message because sending is unavailable. |
...
| SMS | false | 16100919 | Failed to send the message because it is within the sending restriction period or message resending is prohibited. |
...
| SMS | false | 17003005 | Failed to send the message because it was not delivered while the device was processing a call. |
...
| ALIMTALK | false | 21901004 | Failed to send the message because the PlusFriend is already registered. |
...
| ALIMTALK | false | 21901006 | Failed to send the message because the senderKey does not exist for the PlusFriend. |
| ALIMTALK | false | 21901010 | Failed to send the message because the PlusFriend group does not exist. |
| ALIMTALK | false | 21901013 | Failed to send the message because the PlusFriend group already exists. |
| ALIMTALK | false | 21901014 | Failed to send the message because the PlusFriend is not in an active state. |
| ALIMTALK | false | 21901016 | Failed to send the message because no message was found matching the requestId or recipientSeq. |
| ALIMTALK | false | 21901017 | Failed to send the message because the daily maximum message count has been exceeded. |
| ALIMTALK | false | 21901018 | Failed to send the message because the PlusFriend has already been added. |
...
| ALIMTALK | false | 21901022 | Failed to send the message because the PlusFriend has not been added to the group. |
| ALIMTALK | false | 21901023 | Failed to send the message because the maximum PlusFriend group size of 10 has been exceeded. |
| ALIMTALK | false | 21901024 | Failed to send the message because sender groups cannot send messages. |
| ALIMTALK | false | 21901025 | Failed to send the message because sender groups cannot be deleted. |
...
| ALIMTALK | false | 21901029 | Failed to send the message because blacklisted senders cannot join a group. |
...
| ALIMTALK | false | 21902017 | Failed to send the message because the PlusFriend does not exist. |
...
| ALIMTALK | false | 21902502 | Failed to send the message because PlusFriend resending settings are required. |
...
| ALIMTALK | false | 21903000 | Failed to send the message because linkMo was not entered when the template has a WL (webLink). |
| ALIMTALK | false | 21903001 | Failed to send the message because the templateCode or templateName already exists. |
| ALIMTALK | false | 21903002 | Failed to send the message because the field is invalid. |
...
| ALIMTALK | false | 21903012 | Failed to send the message because the template can only be modified when its status is TSC03/APPROVE or TSC04/REJECT. |
...
| ALIMTALK | false | 21903015 | Failed to send the message because the use of CBT features is not allowed for this PlusFriend. |
| ALIMTALK | false | 21903016 | Failed to send the message because the template with emphasizeType 'TEXT' is missing templateTitle and templateSubtitle. |
| ALIMTALK | false | 21903017 | Failed to send the message because templateSubtitle contains a replacement parameter. |
| ALIMTALK | false | 21903018 | Failed to send the message because the template with messageType 'EX' is missing templateExtra. |
| ALIMTALK | false | 21903020 | Failed to send the message because the template with messageType 'MI' is missing templateExtra. |
| ALIMTALK | false | 21903021 | Failed to send the message because templateExtra contains a replacement parameter. |
| ALIMTALK | false | 21903024 | Failed to send the message because AC type buttons can only be used with templateMessageType (AD/MI). |
| ALIMTALK | false | 21903025 | Failed to send the message because the AC type button must be placed alone or at the top. |
| ALIMTALK | false | 21903026 | Failed to send the message because the AC type button name does not include 'Add Channel'. |
| ALIMTALK | false | 21903027 | Failed to send the message because the template with emphasizeType 'NONE' contains templateTitle or templateSubtitle. |
...
| ALIMTALK | false | 21903041 | Failed to send the message because the imageUrl is missing http:// or https://. |
...
| ALIMTALK | false | 21903044 | Failed to send the message because a BF type button must be placed at the top, but this requirement was not met. |
...
| ALIMTALK | false | 21903100 | Failed to send the message because adding a comment is not allowed when the template is in a registered/completed status. |
...
| ALIMTALK | false | 21903200 | Failed to send the message because the FriendTalk wide item is missing a title. |
| ALIMTALK | false | 21903201 | Failed to send the message because the FriendTalk wide item is missing an image. |
| ALIMTALK | false | 21903202 | Failed to send the message because the FriendTalk wide item is missing linkMo. |
...
| ALIMTALK | false | 21903204 | Failed to send the message because the FriendTalk carousel is missing a header. |
| ALIMTALK | false | 21903205 | Failed to send the message because the FriendTalk carousel is missing a message. |
| ALIMTALK | false | 21903206 | Failed to send the message because the FriendTalk carousel is missing an attachment. |
| ALIMTALK | false | 21903207 | Failed to send the message because the FriendTalk carousel is missing an image. |
...
| ALIMTALK | false | 21903209 | Failed to send the message because the FriendTalk carousel tail is missing linkMo. |
| ALIMTALK | false | 21903210 | Failed to send the message because the FriendTalk coupon is missing a title and description. |
...
| ALIMTALK | false | 21903213 | Failed to send the message because the FriendTalk message is missing a mobile link or iOS/Android channel link. |
...
| ALIMTALK | false | 21903216 | Failed to send the message because the first wide item title exceeds 25 characters, or wide item titles 2 through 4 exceed 30 characters. |
| ALIMTALK | false | 21903217 | Failed to send the message because the number of FriendTalk buttons is invalid (up to 5 by default; up to 4 with a coupon; up to 2 with a wide image; up to 1 with a video; 1 to 2 for commerce type). |
...
| ALIMTALK | false | 21903223 | Failed to send the message because the FriendTalk carousel (feed type) cannot contain a 'commerce' field. |
| ALIMTALK | false | 21903224 | Failed to send the message because the FriendTalk carousel (commerce type) cannot contain 'header' or 'message' fields. |
| ALIMTALK | false | 21903225 | Failed to send the message because the number of FriendTalk carousel buttons is invalid (up to 2 for feed type; 1 to 2 for commerce type). |
| ALIMTALK | false | 21903226 | Failed to send the message because commerce contains 'discountPrice' but is missing either 'discountRate' or 'discountFixed'. |
...
| ALIMTALK | false | 21904003 | Failed to send the message because the search range is limited to within 31 days. |
...
| ALIMTALK | false | 21904008 | Failed to send the message because the file size exceeds the 20 MB limit. |
...
| ALIMTALK | false | 21904012 | Failed to send the message because the number of recipients exceeds the maximum limit of 10,000. |
...
| ALIMTALK | false | 21904014 | Failed to send the message because the file is missing the recipient_no header. |
| ALIMTALK | false | 21904015 | Failed to send the message because the requestId is invalid. |
| ALIMTALK | false | 21904016 | Failed to send the message because no data exists. |
| ALIMTALK | false | 21904017 | Failed to send the message because messages older than 90 days cannot be searched. |
| ALIMTALK | false | 21904018 | Failed to send the message due to an error uploading the attachment. |
...
| ALIMTALK | false | 21904021 | Failed to send the message because the file size exceeds the 10 MB limit. |
| ALIMTALK | false | 21904022 | Failed to send the message because data export failed. |
| ALIMTALK | false | 21904023 | Failed to send the message because all senders must be deleted to deactivate the product, but this requirement was not met. |
| ALIMTALK | false | 21904024 | Failed to send the message because releasing the dormant template failed. |
...
| ALIMTALK | false | 21908002 | Failed to send the message because the required image (for example, for carousel-feed or commerce) is missing. |
...
| ALIMTALK | false | 21908005 | Failed to send the message because no Plus Friend exists in the project. (Register a Plus Friend first.) |
...
| ALIMTALK | false | 21909993 | Failed to send the message because the required request part does not exist. |
| ALIMTALK | false | 21909994 | Failed to send the message because the method argument type is not as expected. |
...
| ALIMTALK | false | 22000002 | Failed to send the message due to an error during flow sequential send processing. |
| ALIMTALK | false | 22000003 | Failed to send the message due to an error while preparing to send the message. |
...
| ALIMTALK | false | 23001006 | Failed to send the message because the sender profile has been deleted (contact customer support). |
| ALIMTALK | false | 23001007 | Failed to send the message because the sender profile is in a blocked state (contact customer support). |
...
| ALIMTALK | false | 23001027 | Failed to send the message because the channel message is under sanctions. |
...
| ALIMTALK | false | 23002005 | Failed to send the message because image information could not be retrieved due to an internal Kakao system error. |
...
| ALIMTALK | false | 23003018 | Failed to send the message because sending is not possible (e.g., mismatch between Android device SIM number and KakaoTalk number, user is not active, or user is under sanctions). |
...
| ALIMTALK | false | 23003022 | Failed to send the message because it is outside the allowed sending hours (Friend Talk is available from 8 AM to 8:50 PM). |
...
| ALIMTALK | false | 23003025 | Failed to send the message because the variable character limit has been exceeded. |
| ALIMTALK | false | 23003026 | Failed to send the message because the character limit for the consultation/bot switch button (extra, event) has been exceeded. |
| ALIMTALK | false | 23003027 | Failed to send the message because the message buttons/quick links do not match the template. |
...
| ALIMTALK | false | 23003038 | Failed to send the message because the item summary information does not match the template. |
...
| ALIMTALK | false | 23003041 | Failed to send the message because the number of wide item list items is outside the allowed range. |
...
| ALIMTALK | false | 23003051 | Failed to send the message because the number of carousel items is outside the allowed range. |
...
| ALIMTALK | false | 23009998 | A system issue has occurred and is currently being investigated. Message sending is currently unavailable. |
...
| FRIENDTALK | false | 31901027 | Failed to send the message because the sender is blocked. |
| FRIENDTALK | false | 31901028 | Failed to send the message because the template value exceeds 14 characters. |
| FRIENDTALK | false | 31901029 | Failed to send the message because a blacklisted sender cannot join the group. |
...
| FRIENDTALK | false | 31902025 | Failed to send the message because a past date cannot be used. (Check requestDate.) |
| FRIENDTALK | false | 31902026 | Failed to send the message because a date more than 90 days in the future cannot be used. (Check requestDate.) |
...
| FRIENDTALK | false | 31902502 | Failed to send the message because the Plus Friend resending configuration is required. |
...
| FRIENDTALK | false | 31903006 | Failed to send the message because linkMo/linkPc does not contain http:// or https://. |
...
| FRIENDTALK | false | 31903010 | Failed to send the message because the content does not match the template. (SMS substitution is available upon resending.) |
| FRIENDTALK | false | 31903011 | Failed to send the message because the buttons/quickReplies do not match the template. (SMS substitution is available upon resending.) |
...
| FRIENDTALK | false | 31903015 | Failed to send the message because the use of the CBT feature is not allowed for this Plus Friend. |
| FRIENDTALK | false | 31903016 | Failed to send the message because a template with emphasizeType set to 'TEXT' is missing templateTitle and templateSubtitle. |
...
| FRIENDTALK | false | 31903024 | Failed to send the message because the AC type button can only be used with templateMessageType (AD/MI), but this requirement was violated. |
| FRIENDTALK | false | 31903025 | Failed to send the message because the AC type button must be placed alone or at the top, but this requirement was violated. |
| FRIENDTALK | false | 31903026 | Failed to send the message because the AC type button name does not contain the text 'Add Channel'. |
...
| FRIENDTALK | false | 31903033 | Failed to send the message because the specified button/quickReply does not exist in the template. |
| FRIENDTALK | false | 31903034 | Failed to send the message because the template cannot be deleted due to a recently sent message. (requestId: {}) |
| FRIENDTALK | false | 31903035 | Failed to send the message because required fields are missing from the template with emphasizeType 'ITEM_LIST'. (templateImageInfo, templateHeader, templateItem, etc.) |
...
| FRIENDTALK | false | 31903040 | Failed to send the message because the title (up to 21 characters) or description (up to 13 characters) limit for itemHighlight with a thumbnail was exceeded. |
| FRIENDTALK | false | 31903041 | Failed to send the message because imageUrl does not start with http:// or https://. |
...
| FRIENDTALK | false | 31903044 | Failed to send the message because the BF type button must be placed at the top, but this requirement was violated. |
| FRIENDTALK | false | 31903045 | Failed to send the message because the 'BF' link type button requires a bizFormKey, and the button name must be one of "Book in Talk", "Survey in Talk", or "Enter in Talk", but this requirement was violated. |
...
| FRIENDTALK | false | 31903050 | Failed to send the message because the AC type button is required for templateMessageType (AD/MI) but is missing. |
| FRIENDTALK | false | 31903100 | Failed to send the message because adding a comment is not allowed when the template is in the registered/completed state. |
...
| FRIENDTALK | false | 31903203 | Failed to send the message because the Friend Talk wide item does not have 3 to 4 list items and a header. |
...
| FRIENDTALK | false | 31903208 | Failed to send the message because the number of Friend Talk carousel items does not meet the requirements (2 to 10 items, or 1 to 10 items when commerce+intro is included). |
...
| FRIENDTALK | false | 31903211 | Failed to send the message because the coupon description in a text/image type Friend Talk exceeds the limit. (up to 12 characters by default; up to 18 characters for wide-image/wide-item-list) |
...
| FRIENDTALK | false | 31903215 | Failed to send the message because Friend Talk wide items/carousels can only be sent as the AD type, but this requirement was violated. |
| FRIENDTALK | false | 31903216 | Failed to send the message because the title limit was exceeded for the first wide item (up to 25 characters) or items 2 to 4 (up to 30 characters). |
| FRIENDTALK | false | 31903217 | Failed to send the message because the number of Friend Talk buttons does not meet the requirements (up to 5 by default; up to 4 with a coupon; up to 2 with wide; up to 1 with video; 1 to 2 with commerce). |
| FRIENDTALK | false | 31903218 | Failed to send the message because the Friend Talk video URL is not valid. |
| FRIENDTALK | false | 31903219 | Failed to send the message because 'content' is too long. (up to 76 characters when video is used) |
| FRIENDTALK | false | 31903220 | Failed to send the message because 'header' is too long. (up to 20 characters when video is used) |
...
| FRIENDTALK | false | 31903224 | Failed to send the message because the Friend Talk carousel (commerce type) has 'header' or 'message' fields. |
| FRIENDTALK | false | 31903225 | Failed to send the message because the number of Friend Talk carousel buttons does not meet the requirements (up to 2 for feed; 1 to 2 for commerce). |
| FRIENDTALK | false | 31903226 | Failed to send the message because if commerce has 'discountPrice', either 'discountRate' or 'discountFixed' is required, but it is missing. |
| FRIENDTALK | false | 31903300 | Failed to send the message because the opt-out number could not be found. |
| FRIENDTALK | false | 31903301 | Failed to send the message because the opted-out recipient could not be found. |
| FRIENDTALK | false | 31903302 | Failed to send the message because marketing consent messages can only be sent as text, image, wide image, carousel feed, or premium video types. |
| FRIENDTALK | false | 31904000 | Failed to send the message due to an invalid parameter. |
| FRIENDTALK | false | 31904001 | Failed to send the message because the appkey is already activated. |
| FRIENDTALK | false | 31904002 | Failed to send the message because the appkey is deactivated. |
| FRIENDTALK | false | 31904003 | Failed to send the message because search is only available within the last 31 days. |
| FRIENDTALK | false | 31904004 | Failed to send the message because the appkey does not exist. |
| FRIENDTALK | false | 31904005 | Failed to send the message because the appkey is deactivated. |
...
| FRIENDTALK | false | 31904008 | Failed to send the message because the file size exceeds the limit of 20 MB. |
...
| FRIENDTALK | false | 31904012 | Failed to send the message because the number of recipients exceeds the maximum limit of 10,000. |
| FRIENDTALK | false | 31904013 | Failed to send the message because only jpg/jpeg extensions can be uploaded. |
...
| FRIENDTALK | false | 31904018 | Failed to send the message due to an attachment upload error. |
...
| FRIENDTALK | false | 31904021 | Failed to send the message because the file size exceeds the limit of 10 MB. |
| FRIENDTALK | false | 31904022 | Failed to send the message because data export failed. |
| FRIENDTALK | false | 31904023 | Failed to send the message because all senders must be deleted to deactivate the product, but this requirement was not met. |
...
| FRIENDTALK | false | 31904027 | Failed to send the message because the AD/MI type conversion failed: the 'buttons' length exceeds the maximum limit. |
| FRIENDTALK | false | 31904028 | Failed to send the message because the AD/MI type conversion failed: the template is not in the approved state. |
| FRIENDTALK | false | 31904101 | Failed to send the message due to an invalid search parameter. |
...
| FRIENDTALK | false | 31908002 | Failed to send the message because the image could not be found. (carousel-feed requires the carousel type; carousel-commerce requires the commerce type; commerce requires the IMAGE type) |
...
| FRIENDTALK | false | 31909993 | Failed to send the message because a required part of the request is missing. |
| FRIENDTALK | false | 31909994 | Failed to send the message because the method argument type does not match the expected type. |
...
| FRIENDTALK | false | 32000002 | Failed to send the message due to an error that occurred while processing the flow sequential sending. |
| FRIENDTALK | false | 32000003 | Failed to send the message due to an error that occurred while preparing the message for sending. |
...
| FRIENDTALK | false | 33001024 | Message delivery failed due to a KakaoTalk channel that is pending deletion. |
| FRIENDTALK | false | 33001025 | Message delivery failed because the channel is under sanctions. |
| FRIENDTALK | false | 33001027 | Message delivery failed because the channel message is under sanctions. |
| FRIENDTALK | false | 33001030 | Message delivery failed due to an invalid parameter request. |
| FRIENDTALK | false | 33002001 | Message delivery failed because sending is not possible (unexpected error). |
| FRIENDTALK | false | 33002003 | Message delivery failed because the KakaoTalk channel has not been added on the test server. |
| FRIENDTALK | false | 33002005 | Message delivery failed because image information could not be retrieved due to a Kakao internal system error. |
| FRIENDTALK | false | 33003000 | Message delivery failed due to an unexpected error. |
| FRIENDTALK | false | 33003005 | Message delivery failed because the message was sent but receipt could not be confirmed (uncertain success). |
...
| FRIENDTALK | false | 33003018 | Message delivery failed because the message could not be sent. (Causes include a mismatch between the SIM card number and the KakaoTalk number on Android devices, inactive user, sanctioned user, etc.) |
...
| FRIENDTALK | false | 33003022 | Message delivery failed because the current time is outside the allowed sending hours (FriendTalk: 8:00 AM to 8:50 PM). |
...
| FRIENDTALK | false | 33003027 | Message delivery failed because the message button/quick link does not match the template. |
| FRIENDTALK | false | 33003028 | Message delivery failed because the message emphasis title does not match the template. |
| FRIENDTALK | false | 33003029 | Message delivery failed because the message emphasis title length limit (50 characters) was exceeded. |
...
| FRIENDTALK | false | 33003032 | Message delivery failed because the header length limit (16 characters) was exceeded. |
| FRIENDTALK | false | 33003033 | Message delivery failed because the item highlight does not match the template. |
| FRIENDTALK | false | 33003034 | Message delivery failed because the item highlight title length limit (30 characters without image / 21 characters with image) was exceeded. |
| FRIENDTALK | false | 33003035 | Message delivery failed because the item highlight description length limit (19 characters without image / 13 characters with image) was exceeded. |
| FRIENDTALK | false | 33003036 | Message delivery failed because the item list does not match the template. |
| FRIENDTALK | false | 33003037 | Message delivery failed because the item list description length limit (23 characters) was exceeded. |
| FRIENDTALK | false | 33003038 | Message delivery failed because the item summary does not match the template. |
| FRIENDTALK | false | 33003039 | Message delivery failed because the item summary description length limit (14 characters) was exceeded. |
| FRIENDTALK | false | 33003040 | Message delivery failed because the item summary description contains disallowed characters. |
| FRIENDTALK | false | 33003041 | Message delivery failed because the wide item list count is out of range. |
...
| FRIENDTALK | false | 33003051 | Message delivery failed because the carousel item list count is out of range. |
| FRIENDTALK | false | 33003052 | Message delivery failed because the carousel item message length was exceeded. |
...
| FRIENDTALK | false | 33004000 | Message delivery failed because the message delivery result could not be found. |
| FRIENDTALK | false | 33004001 | Message delivery failed due to an unknown message status. |
| FRIENDTALK | false | 33009998 | A system issue has occurred and is being investigated by the responsible team (service is currently unavailable). Message delivery is not possible. |
| FRIENDTALK | false | 33009999 | Message delivery failed due to an unknown system error. (The responsible team is investigating.) |
...
| RCS | false | 41904023 | Message delivery failed because the template does not allow advertising. |
...
| RCS | false | 42000003 | Message delivery failed due to an error while preparing to send the message. |
...
| RCS | false | 46040007 | Message delivery failed because the permission scope is insufficient. |
...
| RCS | false | 46041007 | Message delivery failed because it was canceled (cancellation processed). |
...
| RCS | false | 46041200 | Message delivery failed because the message recipient could not be found. |
...
| RCS | false | 46042039 | Message delivery failed due to duplicate image alignment. |
...
| RCS | false | 46042315 | Failed to send the message because Openrichcard contains too many child elements. |
...
| RCS | false | 46050010 | Unable to send the message due to an outstanding payment. |
...
| RCS | false | 46051907 | Failed to send the message due to an expired webhook message. |
...
| RCS | false | 46051912 | Failed to send the message due to a webhook send preparation failure. |
| RCS | false | 46051913 | Failed to send the message due to a failure to update the webhook send result status. |
...
| RCS | false | 46051930 | Failed to send the message due to a webhook command error log that was not received. |
...
| RCS | false | 46052098 | Failed to send the message due to a non-modifiable field. |
| RCS | false | 46052099 | Failed to send the message due to a non-modifiable chatbot. |
...
| RCS | false | 46054002 | Failed to send the message because RCS features are not supported. |
| RCS | false | 46054003 | Failed to send the message because delivery to the recipient is not possible. |
| RCS | false | 46054004 | Failed to send the message due to an internal server error. |
| RCS | false | 46055001 | Failed to send the message due to an enterprise content error. |
...
| RCS | false | 46055712 | Failed to send the message because the media exceeded the maximum size limit. |
...
| RCS | false | 46055807 | Failed to send the message due to invalid chatbot permissions. |
| RCS | false | 46055808 | Failed to send the message due to an invalid chatbot status. |
| RCS | false | 46055809 | Failed to send the message due to invalid agency permissions. |
| RCS | false | 46055810 | Failed to send the message because the expiration field is invalid. |
...
| RCS | false | 46055813 | Failed to send the message because the button text exceeded the maximum length. |
...
| RCS | false | 46055887 | Failed to send the message due to a chatbot that is not allowed in the session message. |
...
| EMAIL | false | 51100005 | Failed to send the email because the recipient has refused to receive emails. |
| EMAIL | false | 51100006 | Failed to send the email because the reservation was canceled. |
| EMAIL | false | 51100007 | Failed to send the email because the sending domain is not verified. |
| EMAIL | false | 51100008 | Failed to send the email due to whitelist filtering. |
| EMAIL | false | 52000002 | Failed to send the message due to an error that occurred while processing the flow sequential send. |
| EMAIL | false | 52000003 | Failed to send the message due to an error that occurred while preparing to send the message. |
| EMAIL | false | 52100003 | Failed to send the email. |
| EMAIL | false | 56100002 | Failed to send the email because it was bounced by the receiving SMTP server. |
| PUSH | false | 61100004 | Failed to send the push notification due to a message format error. |
| PUSH | false | 61100005 | Failed to send the push notification because authentication of the registered certificate/API key failed. |
| PUSH | false | 61100006 | Failed to send the push notification because authentication of the registered certificate/API key failed. |
| PUSH | false | 61100014 | Failed to send the duplicate message due to the duplicate send prevention feature. |
| PUSH | false | 62000002 | Failed to send the message due to an error that occurred while processing the flow sequential send. |
| PUSH | false | 62000003 | Failed to send the message due to an error that occurred while preparing to send the message. |
| PUSH | false | 62100007 | Failed to send the push notification because the internal message TTL was exceeded. |
| PUSH | false | 62100009 | (This code is not in use.) |
| PUSH | false | 62100012 | Failed to send the push notification due to an internal error. |
...
| PUSH | false | 64100001 | Push delivery failed because the token has opted out of receiving messages. |
| PUSH | false | 67100002 | Push delivery failed because no contact has been registered. |
