...
| Common | false | 400106 | Failed to remove the email from the opt-out list. |
...
| Common | false | 400121 | This domain is not shared with users of other organizations. |
...
| Common | false | 400327 | The content replaced by template parameters cannot exceed 1,000 characters. |
...
| Common | false | 400336 | The template subject replaced by template parameters cannot exceed 50 characters. |
...
| Common | false | 400357 | A template that is already being modified exists. |
...
| Common | false | 400372 | The template cannot be deleted because of recently sent messages. |
...
| Common | false | 400388 | Comments cannot be added when the template status is registered or completed. |
...
| Common | false | 400393 | A FriendTalk wide item must have linkMo. |
| Common | false | 400394 | A FriendTalk wide item must have between 3 and 4 list items and a header. |
...
| Common | false | 400399 | A FriendTalk carousel must have between 2 and 10 list items. |
| Common | false | 400400 | A FriendTalk carousel tail must have linkMo. |
...
| Common | false | 400416 | If the commerce has a 'discounted price' field, it must have a 'discount rate' or 'fixed discount amount' field. |
...
| Common | false | 400420 | Searches are only available within the last 31 days. |
| Common | false | 400421 | The app key status is disabled. |
...
| Common | false | 400429 | requestId is invalid. |
| Common | false | 400430 | Messages older than 90 days cannot be retrieved. |
| Common | false | 400431 | An error occurred while uploading the file. |
...
| Common | false | 400435 | Failed to export the data. |
| Common | false | 400436 | All senders must be deleted before the product can be deactivated. |
...
| Common | false | 400442 | Invalid search parameter. |
| Common | false | 400443 | The RequestId or the start/end request date is invalid. |
| Common | false | 400444 | RequestId is empty. |
| Common | false | 400445 | The resend message is invalid. |
...
| Common | false | 400454 | The content contains a prohibited word. |
...
| Common | false | 400508 | The certificate is already completed. |
| Common | false | 400509 | Too many. |
| Common | false | 400510 | Unsupported API version. |
...
| Common | false | 400515 | Unsupported HTTP method. |
...
| Common | false | 400600 | The SMS project is disabled. |
...
| Common | false | 400604 | Only one card can be registered for the horizontal or vertical type. |
...
| Common | false | 400608 | Unsupported template. |
...
| Common | false | 400614 | An empty media was uploaded. |
...
| Common | false | 400618 | Unsupported type. |
...
| Common | false | 400700 | No identity verification record found. |
| Common | false | 404000 | {0} not found.<br>The contact was not found.<br>The recipient was not found.<br>The self-verification was not found.<br>The identity verification record was not found.<br>The content was not found.<br>The attachment was not found.<br>The category was not found.<br>The project was not found.<br>The recipient set was not found.<br>The recipient sending result (messageId: {0}, recipientIndex: {1}) does not exist.<br>The contact sending result (messageId: {0}, recipientIndex: {1}, contactIndex: {2}) does not exist. |
...
| Common | false | 404314 | No sender profile is registered in your project. |
...
| Common | false | 500002 | Invalid state server error |
| Message Sending | false | 400001 | The number of contacts has been exceeded.<br>The flow sending order is empty.<br>The initial flow sending channel is empty.<br>The flow sending order is invalid.<br>Duplicate message channel.<br>Cannot add message recipients.<br>Invalid phone number pattern.<br>Invalid email address pattern.<br>Invalid token pattern.<br>{0} is an invalid Alim Talk template status.<br>The email local part length has been exceeded.<br>The email address length has been exceeded.<br>The email domain length has been exceeded.<br>The phone number is empty.<br>The phone number {0} contains non-numeric characters.<br>Invalid phone number. {0}<br>Invalid date format. {0}<br>{0} is an invalid
...
<td>MBR.9002</td>
<td>번호 변작 의심</td>
<td>Suspected phone number spoofing</td>
</tr>
<tr>
<td>MBR.9003</td>
<td>발신 번호 불일치</td>
<td>Sender number mismatch</td>
</tr>
<tr>
<td>MBR.9999</td>
<td>기타 오류</td>
...
| Category | isSuccessful | resultCode | resultMessage |
| --- | --- | --- | --- |
...
| SMS | false | 16003000 | Failed to send the message because the message cannot be sent. |
...
| SMS | false | 16004005 | Failed to send the message because there is no subscriber. |
...
| SMS | false | 16100919 | Failed to send the message because it is within the send restriction period or message resending is prohibited. |
...
| SMS | false | 17003001 | Failed to send the message because there is no subscriber. |
| SMS | false | 17003003 | Failed to send the message due to a recipient number format error or non-existent number. |
| SMS | false | 17003004 | Failed to send the message because the device service is temporarily suspended. |
| SMS | false | 17003005 | Failed to send the message because it could not be delivered while the device was processing a call. |
...
| SMS | false | 17003017 | Failed to send the message because the number format is invalid due to the sender number spoofing prevention service. |
| SMS | false | 17003018 | Failed to send the message because it is a personal mobile number registered with the sender number spoofing prevention service. |
...
| ALIMTALK | false | 21901017 | Failed to send the message because the daily maximum message count was exceeded. |
...
| ALIMTALK | false | 21901029 | Failed to send the message because a blacklisted sender cannot join the group. |
...
| ALIMTALK | false | 21903001 | Failed to send the message because templateCode or templateName already exists. |
...
| ALIMTALK | false | 21903010 | Failed to send the message because the content does not match the template. (SMS substitution is possible when resend settings are configured.) |
| ALIMTALK | false | 21903011 | Failed to send the message because the buttons/quickReplies do not match the template. (SMS substitution is possible when resend settings are configured.) |
...
| ALIMTALK | false | 21903015 | Failed to send the message because CBT feature usage is not allowed for this Plus Friend. |
...
| ALIMTALK | false | 21903035 | Failed to send the message because the template with emphasizeType 'ITEM_LIST' is missing required items (templateImageInfo, templateHeader, templateItem, etc.). |
...
| ALIMTALK | false | 21903037 | Failed to send the message because the title in templateItem contains a replacement parameter. |
| ALIMTALK | false | 21903038 | Failed to send the message because the summary title in templateItem contains a replacement parameter. |
| ALIMTALK | false | 21903039 | Failed to send the message because a summary cannot exist without a templateItem list. |
| ALIMTALK | false | 21903040 | Failed to send the message because the itemHighlight with thumbnail exceeded the title (maximum 21 characters) or description (maximum 13 characters) limit. |
| ALIMTALK | false | 21903041 | Failed to send the message because imageUrl does not include http:// or https://. |
| ALIMTALK | false | 21903042 | Failed to send the message because templateHeader does not match the template. (SMS substitution when resending.) |
| ALIMTALK | false | 21903043 | Failed to send the message because templateItem or templateItemHighlight does not match the template. (SMS substitution when resending.) |
| ALIMTALK | false | 21903044 | Failed to send the message because the BF type button must be placed at the top. |
| ALIMTALK | false | 21903045 | Failed to send the message because the 'BF' link type button requires a bizFormKey and the button name must be one of "Reserve in Talk", "Survey in Talk", or "Enter in Talk". |
| ALIMTALK | false | 21903046 | Failed to send the message because templateRepresentLink does not match the template. (SMS substitution when resending.) |
| ALIMTALK | false | 21903047 | Failed to send the message because templateTitle and the title in templateItemHighlight end with a space. |
| ALIMTALK | false | 21903048 | Failed to send the message because the template parameter length exceeds 1,000 characters. |
| ALIMTALK | false | 21903049 | Failed to send the message because the template parameter does not match the template. |
| ALIMTALK | false | 21903050 | Failed to send the message because the AC type button is required in templateMessageType (AD/MI) but is missing. |
...
| ALIMTALK | false | 21903203 | Failed to send the message because the FriendTalk wide item requires at least 3 to 4 list items and a header, which are missing. |
...
| ALIMTALK | false | 21903208 | Failed to send the message because the FriendTalk carousel item count (2 to 10, or 1 to 10 when including intro) is incorrect. |
...
| ALIMTALK | false | 21903211 | Failed to send the message because the coupon description exceeded the limit for FriendTalk text/image type (maximum 12 characters) or wide-image/item-list type (maximum 18 characters). |
...
| ALIMTALK | false | 21903215 | Failed to send the message because FriendTalk wide items/carousels can only be sent as AD type. |
| ALIMTALK | false | 21903216 | Failed to send the message because the first wide item title (maximum 25 characters) or the 2nd to 4th wide item titles (maximum 30 characters) exceeded the limit. |
| ALIMTALK | false | 21903217 | Failed to send the message because the FriendTalk button count (up to 5 by default, up to 4 with a coupon, up to 2 with wide, up to 1 with video, 1 to 2 with commerce) is incorrect. |
...
| ALIMTALK | false | 21903221 | Failed to send the message because the FriendTalk carousel (feed type) contains the 'head' field. |
| ALIMTALK | false | 21903222 | Failed to send the message because the FriendTalk carousel (feed type) contains the 'additionalContent' field. |
| ALIMTALK | false | 21903223 | Failed to send the message because the FriendTalk carousel (feed type) cannot include the 'commerce' field. |
| ALIMTALK | false | 21903224 | Failed to send the message because the FriendTalk carousel (commerce type) cannot include the 'header' or 'message' fields. |
| ALIMTALK | false | 21903225 | Failed to send the message because the FriendTalk carousel button count (maximum 2 for feed, 1 to 2 for commerce) is incorrect. |
| ALIMTALK | false | 21903226 | Failed to send the message because if commerce has 'discountPrice', either 'discountRate' or 'discountFixed' is required but missing. |
...
| ALIMTALK | false | 21903302 | Failed to send the message because marketing consent messages can only be sent as text/image/wide image/carousel feed/premium video type. |
...
| ALIMTALK | false | 21904003 | Failed to send the message because only searches within 31 days are possible. |
...
| ALIMTALK | false | 21904008 | Failed to send the message because the file size exceeds 20 MB. |
...
| ALIMTALK | false | 21904012 | Failed to send the message because the maximum recipient count (10,000) has been exceeded. |
...
| ALIMTALK | false | 21904021 | Failed to send the message because the file size exceeds 10 MB. |
| ALIMTALK | false | 21904022 | Failed to send the message because data export failed. |
| ALIMTALK | false | 21904023 | Failed to send the message because all senders must be deleted before deactivating the product, but the condition was not met. |
| ALIMTALK | false | 21904024 | Failed to send the message because deactivating the dormant template failed. |
| ALIMTALK | false | 21904025 | Failed to send the message because only a maximum of 20 templates can be uploaded at once. |
...
| ALIMTALK | false | 21904028 | AD/MI type conversion failed: failed to send the message because the template is not in an approved state. |
...
| ALIMTALK | false | 21909994 | Failed to send the message because the method argument type is different from expected. |
| ALIMTALK | false | 21909995 | Failed to send the message due to an end-of-support version. |
