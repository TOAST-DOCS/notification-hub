<!-- pre-align:aligned sig=78a7c3e5606e -->
...
| Common | false | 400104 | This email is already registered in the opt-out list. |
| Common | false | 400105 | This email is already registered in the opt-out list. |
...
| Common | false | 400109 | This domain is not verified. |
...
| Common | false | 400116 | Domain sharing failed. |
...
| Common | false | 400121 | This domain is not shared with users of another organization. |
...
| Common | false | 400127 | The domain and subdomain are the same. |
...
| Common | false | 400206 | The recipient number is not included in the allowlist. |
...
| Common | false | 400214 | The review has already been processed. |
...
| Common | false | 400309 | The maximum daily message sending limit has been exceeded. |
...
| Common | false | 400317 | The maximum number of members in a group is 5,000. |
| Common | false | 400318 | The sender is in a blocked state. |
...
| Common | false | 400330 | Messages cannot be sent with a past date. |
| Common | false | 400331 | Messages cannot be sent more than 90 days in the future. |
...
| Common | false | 400356 | Only templates in TSC03 (APPROVE)/TSC04 (REJECT) status can be modified. |
...
| Common | false | 400365 | The AC type button can only be used in templateMessageType (AD/MI). |
...
| Common | false | 400388 | Comments cannot be added to templates in the registered/completed status. |
...
| 공통 | false | 400426 | The maximum recipient list has been exceeded. |
| 공통 | false | 400427 | Only jpg/jpeg extensions can be uploaded. |
...
| 공통 | false | 400458 | The type of a method argument does not match what was expected. |
| 공통 | false | 400459 | This version is deprecated. |
| 공통 | false | 400460 | Only the application/json content type is supported. |
| 공통 | false | 400461 | A client error occurred. |
| 공통 | false | 400462 | templateMessageType (AD/MI) must include an AC type button.<br>A system error occurred. |
...
| 공통 | false | 400504 | The certificate is duplicated. |
...
| 공통 | false | 400600 | The SMS project is inactive. |
...
| 공통 | false | 400604 | Only one card can be registered for the horizontal and vertical types. |
...
| 공통 | false | 404000 | {0} cannot be found.<br>The contact cannot be found.<br>The recipient cannot be found.<br>The self-authentication cannot be found.<br>The identity verification record cannot be found.<br>The content cannot be found.<br>The attachment cannot be found.<br>The category cannot be found.<br>The project cannot be found.<br>The recipient set cannot be found.<br>The result of sending to the recipient (messageId: {0}, recipientIndex: {1}) does not exist.<br>Contact sending result (messageId: {0}, recipientIndex: {1}, contactIndex: {2}) does not exist. |
| 공통 | false | 404100 | Failed to retrieve the template. |
| 공통 | false | 404101 | The opt-out information cannot be found. |
| 공통 | false | 404102 | The category information cannot be found. |
| 공통 | false | 404103 | The Excel file cannot be found. |
...
| 공통 | false | 404216 | The Excel file cannot be found. |
| 공통 | false | 404217 | The configCode does not exist. |
| 공통 | false | 404218 | The CSV file cannot be found. |
| 공통 | false | 404219 | This is not a registered unsubscribe number. |
| 공통 | false | 404220 | This number is not registered. |
| 공통 | false | 404221 | This number is already registered. |
| 공통 | false | 404222 | This opt-out number is not registered. |
| 공통 | false | 404300 | The sender profile group does not exist. |
| 공통 | false | 404301 | No message can be found with the requested requestId or recipientSeq. |
| 공통 | false | 404302 | The sender profile does not exist. |
| 공통 | false | 404303 | The message to cancel cannot be found or does not meet the cancellation conditions. |
| 공통 | false | 404304 | The bulk message request cannot be found. |
...
| 공통 | false | 404310 | The file cannot be found. |
| 공통 | false | 404311 | The recipient list cannot be found. |
| 공통 | false | 404312 | The data does not exist. |
| 공통 | false | 404313 | The image cannot be found. |
...
| SMS | false | 11902023 | Failed to send the message because the subject or body contains a character set that is not allowed. |
...
| SMS | false | 11902047 | Failed to send the message because the monthly allowance for international sending has been exceeded. |
...
| SMS | false | 12000003 | Failed to send the message due to an error while preparing to send. |
...
| SMS | false | 16001019 | Failed to send the message because the TTL has been exceeded. |
...
| SMS | false | 16003016 | Failed to send the message because the attachment size limit has been exceeded. |
...
| SMS | false | 16004007 | Failed to send the message due to a carrier error or blocking. |
...
| SMS | false | 16100919 | Failed to send the message because it is within the sending restricted hours or message resending is prohibited. |
...
| SMS | false | 17003019 | Failed to send the message because the sender number has been blocked by KISA or the Ministry of Science and ICT. |
...
| ALIMTALK | false | 21901006 | Failed to send the message because the senderKey does not exist in the Plus Friend. |
...
| ALIMTALK | false | 21901016 | Failed to send the message because no message matching the requestId or recipientSeq was found. |
...
| ALIMTALK | false | 21901023 | Failed to send the message because the Plus Friend group maximum size of 10 has been exceeded. |
...
| ALIMTALK | false | 21901027 | Failed to send the message because the sender has been blocked. |
...
| ALIMTALK | false | 21902025 | Failed to send the message because messages cannot be sent with a past date. Check `requestDate`. |
| ALIMTALK | false | 21902026 | Failed to send the message because messages cannot be sent for a date more than 90 days in the future. Check `requestDate`. |
...
| ALIMTALK | false | 21902502 | Failed to send the message because the Plus Friend resending settings need to be configured. |
...
| ALIMTALK | false | 21903010 | Failed to send the message because the content does not match the template. (SMS fallback is available if resending is configured.) |
| ALIMTALK | false | 21903011 | Failed to send the message because the buttons/quickReplies do not match the template. (SMS fallback is available if resending is configured.) |
...
| ALIMTALK | false | 21903015 | Failed to send the message because the use of CBT features is not allowed for this Plus Friend. |
...
| ALIMTALK | false | 21903024 | Failed to send the message because the AC type button can only be used with templateMessageType (AD/MI). |
...
| ALIMTALK | false | 21903040 | Failed to send the message because the itemHighlight with a thumbnail exceeds the title limit (up to 21 characters) or description limit (up to 13 characters). |
...
| ALIMTALK | false | 21903045 | Failed to send the message because the 'BF' link type button requires a bizFormKey, and the button name must be one of "Reserve on Talk", "Survey on Talk", or "Enter on Talk", but this requirement was not met. |
...
| ALIMTALK | false | 21903050 | Failed to send the message because the templateMessageType (AD/MI) must include an AC type button, but it is missing. |
| ALIMTALK | false | 21903100 | Failed to send the message because adding a comment is not allowed when the template is in the registered/completed status. |
...
| ALIMTALK | false | 21903216 | Failed to send the message because the first wide item title exceeds 25 characters, or items 2 through 4 exceed 30 characters. |
| ALIMTALK | false | 21903217 | Failed to send the message because the number of FriendTalk buttons is invalid (up to 5 by default, up to 4 with a coupon, up to 2 with wide, up to 1 with video, or 1 to 2 for commerce). |
...
| ALIMTALK | false | 21903225 | Failed to send the message because the number of FriendTalk carousel buttons is invalid (up to 2 for feed, 1 to 2 for commerce). |
| ALIMTALK | false | 21903226 | Failed to send the message because commerce has 'discountPrice' but is missing either 'discountRate' or 'discountFixed'. |
...
| ALIMTALK | false | 21903302 | Failed to send the message because marketing consent messages are only allowed for text, image, wide image, carousel feed, and premium video types. |
...
| ALIMTALK | false | 21904012 | Failed to send the message because the maximum number of recipients (10,000) has been exceeded. |
| ALIMTALK | false | 21904013 | Failed to send the message because only jpg/jpeg extensions can be uploaded. |
| ALIMTALK | false | 21904014 | Failed to send the message because the file does not have a recipient_no header. |
...
| ALIMTALK | false | 23001004 | Failed to send the message because the request body (JSON) does not contain a name. |
...
| ALIMTALK | false | 23001012 | Failed to send the message due to an incorrectly formatted user key request. |
...
| ALIMTALK | false | 23002003 | Failed to send the message because the KakaoTalk channel has not been added to the test server. |
...
| ALIMTALK | false | 23003005 | Failed to send the message because the message was sent but receipt was not confirmed (success uncertain). |
...
| ALIMTALK | false | 23003018 | Failed to send the message because sending is not possible (e.g., mismatch between the Android device SIM number and the KakaoTalk number, inactive user, sanctioned user). |
...
| ALIMTALK | false | 23003021 | Failed to send the message because the minimum KakaoTalk version is not supported. |
...
| ALIMTALK | false | 23003030 | Failed to send the message because the message type and template emphasis type do not match. |
| ALIMTALK | false | 23003031 | Failed to send the message because the header does not match the template. |
| ALIMTALK | false | 23003032 | Failed to send the message because the header length exceeds 16 characters. |
| ALIMTALK | false | 23003033 | Failed to send the message because the item highlight does not match the template. |
| ALIMTALK | false | 23003034 | Failed to send the message because the item highlight title length limit was exceeded (30 characters without an image / 21 characters with an image). |
| ALIMTALK | false | 23003035 | Failed to send the message because the item highlight description length limit was exceeded (19 characters without an image / 13 characters with an image). |
| ALIMTALK | false | 23003036 | Failed to send the message because the item list does not match the template. |
| ALIMTALK | false | 23003037 | Failed to send the message because the item list description length limit (23 characters) was exceeded. |
| ALIMTALK | false | 23003038 | Failed to send the message because the item summary does not match the template. |
| ALIMTALK | false | 23003039 | Failed to send the message because the item summary description length limit (14 characters) was exceeded. |
...
| ALIMTALK | false | 23003041 | Failed to send the message because the number of wide item list items is outside the allowed minimum/maximum range. |
| ALIMTALK | false | 23003042 | Failed to send the message because the representative link does not match the template. |
| ALIMTALK | false | 23003046 | Failed to send the message because the additional information maximum length limit was exceeded. |
| ALIMTALK | false | 23003047 | Failed to send the message because the commerce information product name length limit was exceeded. |
| ALIMTALK | false | 23003048 | Failed to send the message due to an invalid group tag key. |
| ALIMTALK | false | 23003051 | Failed to send the message because the number of carousel items is outside the allowed minimum/maximum range. |
...
| ALIMTALK | false | 23004000 | Failed to send the message because the message sending result could not be found. |
| ALIMTALK | false | 23004001 | Failed to send the message due to an unknown message status. |
| ALIMTALK | false | 23009998 | A system issue has occurred and is being investigated. Message sending is currently unavailable. |
...
| FRIENDTALK | false | 31901023 | Failed to send the message because the Plus Friend group maximum size (10) was exceeded. |
...
| FRIENDTALK | false | 31901026 | Failed to send the message because the group maximum member count (5,000) was exceeded. |
...
| FRIENDTALK | false | 31902035 | Failed to send the message because the templateHeader exceeds 16 characters. |
...
| FRIENDTALK | false | 31902501 | Failed to send the message because the sending request deadline has expired. |
...
| FRIENDTALK | false | 31903010 | Failed to send the message because the content does not match the template. (SMS fallback is available on resend.) |
| FRIENDTALK | false | 31903011 | Failed to send the message because the buttons/quickReplies do not match the template. (SMS fallback is available on resend.) |
...
| FRIENDTALK | false | 31903015 | Failed to send the message because CBT feature usage is not allowed for this Plus Friend. |
...
| FRIENDTALK | false | 31903021 | Failed to send the message because templateExtra contains replacement parameters. |
...
| FRIENDTALK | false | 31903037 | Failed to send the message because the title of templateItem contains replacement parameters. |
| FRIENDTALK | false | 31903038 | Failed to send the message because the summary title of templateItem contains replacement parameters. |
| FRIENDTALK | false | 31903039 | Failed to send the message because a summary cannot exist without a templateItem list. |
| FRIENDTALK | false | 31903040 | Failed to send the message because the itemHighlight with a thumbnail exceeded the character limit for title (up to 21 characters) or description (up to 13 characters). |
| FRIENDTALK | false | 31903041 | Failed to send the message because imageUrl does not include http:// or https://. |
| FRIENDTALK | false | 31903042 | Failed to send the message because templateHeader does not match the template. (Replaced with SMS on resend) |
| FRIENDTALK | false | 31903043 | Failed to send the message because templateItem or templateItemHighlight does not match the template. (Replaced with SMS on resend) |
...
| FRIENDTALK | false | 31903045 | Failed to send the message because the 'BF' link type button requires bizFormKey, and the button name must be one of "Book in Talk", "Survey in Talk", or "Enter in Talk", but this condition was violated. |
| FRIENDTALK | false | 31903046 | Failed to send the message because templateRepresentLink does not match the template. (Replaced with SMS on resend) |
...
| FRIENDTALK | false | 31903100 | Failed to send the message because adding a comment is not allowed when the template is in a registered/completed state. |
| FRIENDTALK | false | 31903101 | Failed to send the message because the quickReply name does not exist. |
| FRIENDTALK | false | 31903102 | Failed to send the message because the quickReply name contains replacement parameters. |
| FRIENDTALK | false | 31903103 | Failed to send the message because the button/quickReply format is invalid. |
| FRIENDTALK | false | 31903200 | Failed to send the message because the FriendTalk wide item does not have a title. |
| FRIENDTALK | false | 31903201 | Failed to send the message because the FriendTalk wide item does not have an image. |
| FRIENDTALK | false | 31903202 | Failed to send the message because the FriendTalk wide item does not have linkMo. |
| FRIENDTALK | false | 31903203 | Failed to send the message because the FriendTalk wide item does not have 3 to 4 lists and a header. |
| FRIENDTALK | false | 31903204 | Failed to send the message because the FriendTalk carousel does not have a header. |
| FRIENDTALK | false | 31903205 | Failed to send the message because the FriendTalk carousel does not have a message. |
| FRIENDTALK | false | 31903206 | Failed to send the message because the FriendTalk carousel does not have an attachment. |
| FRIENDTALK | false | 31903207 | Failed to send the message because the FriendTalk carousel does not have an image. |
| FRIENDTALK | false | 31903208 | Failed to send the message because the number of FriendTalk carousel items is incorrect (from 2 to 10, or from 1 to 10 when commerce+intro is included). |
| FRIENDTALK | false | 31903209 | Failed to send the message because the FriendTalk carousel tail does not have linkMo. |
| FRIENDTALK | false | 31903210 | Failed to send the message because the FriendTalk coupon does not have a title or description. |
| FRIENDTALK | false | 31903211 | Failed to send the message because the coupon description in a text/image type FriendTalk exceeds the character limit. (Up to 12 characters by default; up to 18 characters for wide-image/wide-item-list) |
| FRIENDTALK | false | 31903212 | Failed to send the message because the FriendTalk coupon title is invalid. |
| FRIENDTALK | false | 31903213 | Failed to send the message because FriendTalk does not have a mobile link or an iOS/Android channel link. |
| FRIENDTALK | false | 31903215 | Failed to send the message because FriendTalk wide items/carousels can only be sent as AD type, but this condition was violated. |
| FRIENDTALK | false | 31903216 | Failed to send the message because the character limit was exceeded for the first wide item title (up to 25 characters) or the 2nd to 4th wide item titles (up to 30 characters). |
| FRIENDTALK | false | 31903217 | Failed to send the message because the number of FriendTalk buttons is incorrect. (Up to 5 by default; up to 4 with a coupon; up to 2 with wide; up to 1 with video; from 1 to 2 with commerce) |
| FRIENDTALK | false | 31903218 | Failed to send the message because the FriendTalk video URL is invalid. |
...
| FRIENDTALK | false | 31903221 | Failed to send the message because the FriendTalk carousel (feed type) cannot include the 'head' field. |
| FRIENDTALK | false | 31903222 | Failed to send the message because the FriendTalk carousel (feed type) cannot include the 'additionalContent' field. |
| FRIENDTALK | false | 31903223 | Failed to send the message because the FriendTalk carousel (feed type) cannot include the 'commerce' field. |
| FRIENDTALK | false | 31903224 | Failed to send the message because the FriendTalk carousel (commerce type) has the 'header' or 'message' field. |
| FRIENDTALK | false | 31903225 | Failed to send the message because the number of FriendTalk carousel buttons is incorrect. (Up to 2 for feed; from 1 to 2 for commerce) |
| FRIENDTALK | false | 31903226 | Failed to send the message because if commerce has 'discountPrice', either 'discountRate' or 'discountFixed' is required but is missing. |
| FRIENDTALK | false | 31903300 | Failed to send the message because the unsubscribed number could not be found. |
| FRIENDTALK | false | 31903301 | Failed to send the message because the unsubscribed recipient could not be found. |
| FRIENDTALK | false | 31903302 | Failed to send the message because marketing consent messages can only be sent as text, image, wide image, carousel feed, or premium video type. |
...
| FRIENDTALK | false | 31904008 | Failed to send the message because the file size must be less than 20 MB, but this limit was exceeded. |
| FRIENDTALK | false | 31904009 | Failed to send the message because the file extension is invalid. |
...
| FRIENDTALK | false | 31904015 | Failed to send the message because the requestId is invalid. |
...
| FRIENDTALK | false | 31904021 | Failed to send the message because the file size must be less than 10 MB, but this limit was exceeded. |
...
| FRIENDTALK | false | 31904024 | Failed to send the message because deactivating the dormant template failed. |
| FRIENDTALK | false | 31904025 | Failed to send the message because only up to 20 templates can be uploaded at a time. |
| FRIENDTALK | false | 31904026 | Failed to send the message because the uploaded template header is invalid. |
| FRIENDTALK | false | 31904027 | Failed to send the message because the AD/MI type conversion failed: the length of 'buttons' exceeds the maximum. |
| FRIENDTALK | false | 31904028 | Failed to send the message because the AD/MI type conversion failed: the template is not in an approved state. |
| FRIENDTALK | false | 31904101 | Failed to send the message due to invalid search parameters. |
| FRIENDTALK | false | 31904103 | Failed to send the message because RequestId or startRequestDate/endRequestDate is invalid. |
| FRIENDTALK | false | 31904104 | Failed to send the message because RequestId is empty. |
| FRIENDTALK | false | 31904200 | Failed to send the message because the resend message is invalid. |
...
| FRIENDTALK | false | 31908001 | Failed to send the message because the uploaded image is invalid. |
| FRIENDTALK | false | 31908002 | Failed to send the message because the image could not be found. (carousel-feed requires the carousel type, carousel-commerce requires the commerce type, and commerce requires the IMAGE type) |
| FRIENDTALK | false | 31908003 | Failed to send the message because the image deletion failed. |
...
| FRIENDTALK | false | 31908011 | Failed to send the message because the image type is invalid. |
| FRIENDTALK | false | 31909993 | Failed to send the message because a required part of the request is missing. |
| FRIENDTALK | false | 31909994 | Failed to send the message because the method argument type was not as expected. |
...
| FRIENDTALK | false | 32000002 | Failed to send the message due to an error that occurred while processing the flow sequential delivery. |
| FRIENDTALK | false | 32000003 | Failed to send the message due to an error that occurred while preparing to send the message. |
...
| FRIENDTALK | false | 33001004 | Message sending failed because the name is missing from the request body (JSON). |
...
| FRIENDTALK | false | 33001011 | Message sending failed because the contract information could not be found (contact customer support). |
| FRIENDTALK | false | 33001012 | Message sending failed due to an invalid user key request format. |
...
| FRIENDTALK | false | 33001015 | Message sending failed due to an invalid app user ID request. |
...
| FRIENDTALK | false | 33001021 | Message sending failed due to a blocked KakaoTalk channel. |
| FRIENDTALK | false | 33001022 | Message sending failed due to a closed KakaoTalk channel. |
| FRIENDTALK | false | 33001023 | Message sending failed due to a deleted KakaoTalk channel. |
| FRIENDTALK | false | 33001024 | Message sending failed due to a KakaoTalk channel pending deletion. |
| FRIENDTALK | false | 33001025 | Message sending failed due to a channel sanction. |
| FRIENDTALK | false | 33001027 | Message sending failed due to a channel message sanction. |
| FRIENDTALK | false | 33001030 | Message sending failed due to an invalid parameter request. |
| FRIENDTALK | false | 33002001 | Message sending failed because sending is not possible (unexpected error). |
| FRIENDTALK | false | 33002003 | Message sending failed because the KakaoTalk channel has not been added on the test server. |
| FRIENDTALK | false | 33002005 | Message sending failed because image information could not be retrieved due to a Kakao internal system error. |
...
| FRIENDTALK | false | 33003018 | Message sending failed because the message could not be sent. (Reasons may include a SIM number and KakaoTalk number mismatch on an Android device, inactive user, or sanctioned user.) |
...
| FRIENDTALK | false | 33003021 | Message sending failed because the minimum KakaoTalk version is not supported. |
| FRIENDTALK | false | 33003022 | Message sending failed because it is outside the allowed sending hours (Friend Talk is available from 8 AM to 8:50 PM). |
| FRIENDTALK | false | 33003023 | Message sending failed due to a message syntax error (JSON format). |
| FRIENDTALK | false | 33003024 | Message sending failed because an image included in the message could not be sent (invalid URL/link or specification violation). |
| FRIENDTALK | false | 33003025 | Message sending failed because the variable character limit was exceeded. |
| FRIENDTALK | false | 33003026 | Message sending failed because the character limit for a consultation/bot switch button (extra, event) was exceeded. |
| FRIENDTALK | false | 33003027 | Message sending failed because the message button/quick reply does not match the template. |
| FRIENDTALK | false | 33003028 | Message sending failed because the message emphasis title does not match the template. |
| FRIENDTALK | false | 33003029 | Message sending failed because the message emphasis title length (50 characters) was exceeded. |
| FRIENDTALK | false | 33003030 | Message sending failed because the message type and template emphasis type do not match. |
| FRIENDTALK | false | 33003031 | Message sending failed because the header does not match the template. |
| FRIENDTALK | false | 33003032 | Message sending failed because the header length limit (16 characters) was exceeded. |
| FRIENDTALK | false | 33003033 | Message sending failed because the item highlight does not match the template. |
| FRIENDTALK | false | 33003034 | Message sending failed because the item highlight title length limit (30 characters without image / 21 characters with image) was exceeded. |
| FRIENDTALK | false | 33003035 | Message sending failed because the item highlight description length limit (19 characters without image / 13 characters with image) was exceeded. |
| FRIENDTALK | false | 33003036 | Message sending failed because the item list does not match the template. |
| FRIENDTALK | false | 33003037 | Message sending failed because the item list description length limit (23 characters) was exceeded. |
| FRIENDTALK | false | 33003038 | Message sending failed because the item summary does not match the template. |
| FRIENDTALK | false | 33003039 | Message sending failed because the item summary description length limit (14 characters) was exceeded. |
| FRIENDTALK | false | 33003040 | Message sending failed because the item summary description contains disallowed characters. |
| FRIENDTALK | false | 33003041 | Message sending failed because the wide item list count is out of range. |
...
| FRIENDTALK | false | 33003051 | Message sending failed because the carousel item list count is out of range. |
| FRIENDTALK | false | 33003052 | Message sending failed because the carousel item message length was exceeded. |
...
| FRIENDTALK | false | 33009998 | A system issue has occurred and is being investigated by the responsible team (service is suspended). Message sending is not possible. |
...
| RCS | false | 41904024 | Message sending failed because the template parameter input is missing. |
| RCS | false | 41904025 | Message sending failed because the free template body length was exceeded. |
...
| RCS | false | 41909000 | Message sending failed due to the nighttime advertising sending time restriction. |
| RCS | false | 42000002 | Message sending failed due to an error during flow sequential send processing. |
...
| RCS | false | 46040007 | Message sending failed due to insufficient permission scope. |
...
| RCS | false | 46041200 | Message sending failed because the message recipient user could not be found. |
| RCS | false | 46041201 | Message sending failed because the message is not allowed. |
...
| RCS | false | 46042039 | Message sending failed due to a duplicate image alignment. |
...
| RCS | false | 46042068 | Failed to send the message because ComposeAction is missing a phone number or the text is out of range (1–100 characters). |
| RCS | false | 46042069 | Failed to send the message because ComposeAction voice/video recording message is missing a phone number or has an invalid type (AUDIO/VIDEO). |
...
| RCS | false | 46055001 | Failed to send the message due to a company content error. |
...
| RCS | false | 46055712 | Failed to send the message because the media exceeds the maximum size. |
...
| RCS | false | 46055882 | Failed to send the message due to a missing response ID. |
| RCS | false | 46055883 | Failed to send the message due to an invalid message base product code in the session message. |
...
| RCS | false | 46059001 | Failed to send the message due to a system I/O error. |
| RCS | false | 46059002 | Failed to send the message due to an I/O error. |
...
| EMAIL | false | 51100005 | Failed to send the email because the recipient has opted out of receiving emails. |
...
| PUSH | false | 61100005 | Failed to send the push notification because authentication with the registered certificate/API key failed. |
| PUSH | false | 61100006 | Failed to send the push notification because authentication with the registered certificate/API key failed. |
...
| PUSH | false | 62100007 | Failed to send the push notification because the internal message TTL has expired. |
...
| PUSH | false | 62100014 | The push notification failed to send due to an unsupported message type. |
| PUSH | false | 62109999 | The push notification failed to send due to an internal error. |
| PUSH | false | 63100008 | The push notification failed to send due to an APNS error response. |
| PUSH | false | 63100009 | The push notification failed to send due to an FCM error response. |
| PUSH | false | 63100011 | The push notification failed to send due to an ADM error response. |
| PUSH | false | 64100001 | The push notification failed to send because the token is in an unsubscribed state. |
| PUSH | false | 67100002 | The push notification failed to send because no registered contact was found. |
| PUSH | false | 67100003 | The push notification failed to send because the token has expired. |
| PUSH | false | 67100013 | The push notification failed to send because the token was deleted after the push token retention period (up to 2 years) expired. |
