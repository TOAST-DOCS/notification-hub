...
* [Console] Added the AlimTalk shared template feature
    * Provides message templates that can be used universally regardless of industry, such as for orders, payments, and shipping. You can use them without a separate review process.
* [Console, API] Launched the Branded Message channel
    ...
    * Key differences compared to Branded Messages in the existing KakaoTalk Bizmessage product:
        ...
        * Messages sent to customer members can only be received by users on KakaoTalk 25.4.0 or later
