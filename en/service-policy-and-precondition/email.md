...
## Register sending domain and DNS TXT record { #register-sending-domain-and-dns-txt-record }
...
## Gmail-Related Guidelines { #gmail-related-guidelines }

<a id="enhanced-gmail-and-yahoos-email-receiving-standards"></a>
### Enhanced Gmail and Yahoo's email receiving standards { #enhanced-gmail-and-yahoos-email-receiving-standards }
...
<a id="enhanced-gmail-and-yahoos-email-receiving-standards-restricted-domain-when-spf-dkim-dmarc-authentication-is-not-completed"></a>
...
### Guide about being not possible to collect Viewed Event with Gmail. { #guide-about-being-not-possible-to-collect-viewed-event-with-gmail }
...
<a id="gmails-low-reputation-issue-gmails-reputation-evaluation-method"></a>
...
<a id="gmails-low-reputation-issue-how-to-raise-reputation"></a>
...
<a id="gmails-low-reputation-issue-refer-to-external-documentation-for-reputation"></a>
