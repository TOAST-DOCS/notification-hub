...
- Sending types marked with 'O' in the 'Unified RCS' column in the table below are unified RCS types, which can be received not only on Android devices but also on iPhone devices. (Sending types marked with 'X' are Android RCS types, which can only be received on Android devices.)
...
<table class="custom-table" style="text-align: center">
    ...
    <tr>
        ...
        <td>Image &amp; Title Emphasis (3:4)</td>
        <td>X</td>
    ...
    <tr>
        <td>22</td>
        <td>Image &amp; Title Emphasis (1:1)</td>
        <td>X</td>
        <td>Highlighted Image n Title</td>
        <td>1</td>
        <td>500 characters</td>
