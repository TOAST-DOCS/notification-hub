...
A brand message is a KakaoTalk Bizmessage product that allows you to send advertising messages to members who have agreed to receive marketing communications (hereinafter referred to as marketing consent) from the advertiser, regardless of whether they are KakaoTalk channel friends.
...
Customer-targeted delivery sends messages to users who have agreed to receive marketing messages (MA users) from the advertiser. To use customer-targeted delivery, you must complete the **Customer-Targeted Delivery Use Application** in advance. You must also register an 080 opt-out number in the sender profile. The eligible recipients vary depending on the targeting type.

For more information about applying to use customer-targeted delivery, see **Console User Guide** > **Sender Information** > **Customer-Targeted Delivery Use Application**.
...
* Business-certified channel
* Business registration number registered
* Channel customer service phone number registered
* At least 50,000 channel friends
* A record of at least one successful AlimTalk delivery within the last 3 months

### Friend-Targeted Delivery

Friend-targeted delivery sends messages to all KakaoTalk channel friends. Registering an 080 opt-out number is not required.
...
* The 080 opt-out number is applied collectively to all sender profiles of other organizations, other projects, and other dealers sharing the same KakaoTalk channel.
...
Brand messages are advertising messages, so sending them during nighttime hours is restricted according to the Telecommunications Network Act.

* Delivery restricted during night (20:50~08:00 on the following day)
* If you request delivery during nighttime hours, the message is either treated as a failure or resent after the restriction period ends, depending on the detailed settings.

## Caution

Brand messages are advertising messages, so you must comply with the following requirements:

* The message must display **(ad)** at the very beginning of any content that contains advertising material.
* The sender's name and contact information must appear above the message body.
* The message must clearly specify the measures and methods that make it easy for recipients to opt out or withdraw their consent to receive messages.
* If opting out requires additional steps (such as logging in), this makes opt-out difficult and constitutes a violation of the law.
* If business certification is revoked, the permission to send non-friend messages (targeting M and N) will be revoked as well.
