...
* Organizes your recipients' contacts (email, phone number, token).
    ...
    * Allows you to prevent unnecessary sending by using opt-out numbers.
...
* Allows you to create a flow using pre-registered templates.
    ...
    * You can use it for various purposes, such as increasing delivery rates or reducing sending costs, depending on how you configure the priority of message channels.

<a id="mass-delivery"></a>

### Mass Delivery

* Allows you to send a message to multiple recipients at once.
