...
<span id="identity-verification">

## 본인 인증

<b>Notification Hub를 이용하려면 [콘솔 > 본인 인증 > 발신 번호 등록 및 명의자 인증]에서 발신 번호를 사전에 등록한 후 사용할 수 있습니다. (전기통신사업법 관련 고시 준수)</b>

* 전기통신사업법 관련 고시 준수를 위해 SMS 서비스에 강화된 발신 번호 사전등록제가 적용되었습니다.
* 개인회원은 서비스를 이용할 수 없습니다.
