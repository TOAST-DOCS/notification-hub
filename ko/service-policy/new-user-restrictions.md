...
### 최초 사용자 제한 해제 기준
*  최초 사용자 제한 해제가 필요한 경우 조직 아이디, 프로젝트 아이디, 앱키를 준비하여 NHN Cloud 고객 센터로 문의하세요.
...
* 이외 최초 사용자 제한 해제가 필요한 경우 조직 아이디, 프로젝트 아이디, 앱키, 카카오톡 채널 ID를 준비하여 NHN Cloud 고객 센터로 문의하세요.
