...
* 카카오톡 템플릿 코드
    * 카카오톡 템플릿 코드는 카카오에 등록되는 템플릿과 1:1 관계를 가지는 고유한 코드입니다.
    * 카카오에 등록된 템플릿은 각각 검수, 승인되며 검수관련 문의도 템플릿 별로 이루어집니다. 
    * 최초에는 입력한 템플릿 코드와 동일하게 저장됩니다. 이후 템플릿 수정 시 변경할 수 있습니다.
    * 카카오톡 템플릿 코드를 변경하는 경우 신규 카카오 템플릿의 검수가 진행됩니다.    
* 템플릿 내용
