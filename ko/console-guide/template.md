...
* 카카오톡 템플릿 코드 및 수정방식
    ...
    * 카카오 정책상 승인이 완료된 템플릿은 수정이 불가하지만 본 서비스에서는 사용자 편의를 위해 승인 완료된 템플릿에 대한 수정 기능을 제공합니다.
    * 알림톡 템플릿 수정 시, 기존 카카오톡 템플릿 기반으로 신규 카카오톡 템플릿을 생성하여 카카오에 등록하고, 신규 카카오톡 템플릿이 승인되기 전까지는 기존 카카오톡 템플릿이 발송에 사용됩니다.
    * 이 과정에서 새로운 카카오톡 템플릿 생성이 필요한 경우 사용자는 직접 카카오톡 템플릿 코드를 입력해야 합니다.
    * 검수 중이거나 반려된 카카오톡 템플릿은 동일한 카카오톡 템플릿 코드를 유지한 채 내용 수정 후 재검수 요청이 가능합니다.
    * 알림톡 템플릿 수정 후에도 템플릿 코드는 유지되므로 사용자는 동일한 코드로 계속 발송 할 수 있습니다.
    ...
    * 카카오톡 템플릿 코드를 변경하여 신규 등록할 때마다, 해당 카카오톡 템플릿에 대한 카카오 검수 절차가 새로 진행됩니다.
* 템플릿 내용
