...
### 2026. 01. 27.
#### 기능 추가
* [API] ALIMTALK 템플릿 API 신규 제공 및 일부 API 지원 종료
    * ALIMTALK 채널의 템플릿 관리 구조 변경에 따라 일부 기존 템플릿 API가 신규 API로 대체되었습니다. 자세한 내용은 [API v1.0 사용 가이드 > 템플릿](./api-guide-v1x0/template)을 참고하시기 바랍니다.
* [API] 외부 080 수신거부 번호 관리 API 신규 제공
    * 외부 080 수신거부 번호 등록/삭제, 수신거부 번호 조회 API 가 제공됩니다. 자세한 내용은 [API v1.0 사용 가이드 > 발신 정보](./api-guide-v1x0/sender-unsubscribe)을 참고하시기 바랍니다.
