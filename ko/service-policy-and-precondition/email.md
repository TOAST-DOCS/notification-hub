...
## 발신 도메인과 DNS TXT 레코드 등록 { #register-sending-domain-and-dns-txt-record }
...
## Gmail 관련 안내 사항 { #gmail-related-guidelines }

<a id="enhanced-gmail-and-yahoos-email-receiving-standards"></a>
### Gmail과 Yahoo의 이메일 수신 기준 강화 { #enhanced-gmail-and-yahoos-email-receiving-standards }
...
### Gmail 열람됨 이벤트 수집 불가 안내 { #guide-about-being-not-possible-to-collect-viewed-event-with-gmail }
...
### Gmail 낮은 평판(Low Reputation) 문제 { #gmails-low-reputation-issue }
