...
* 채널 친구뿐만 아니라, 마수동 유저 대상으로 비친구에게도 광고성 메시지를 발송할 수 있습니다.
...
고객 대상 발송은 광고주의 마수동 유저를 대상으로 메시지를 발송합니다. 고객 대상 발송을 사용하려면 사전에 **고객 대상 발송 사용 신청**을 완료해야 합니다. 발신 프로필에 080 수신거부번호 등록이 필요합니다. 타겟팅 유형에 따라 발송 가능 대상이 달라집니다.

고객 대상 발송 사용 신청에 대한 자세한 내용은 **콘솔 사용 가이드** > **발신 정보** > **고객 대상 발송 사용 신청**을 참고하세요.

* **M**: 마케팅 수신 동의 유저 전체를 대상으로 광고성 메시지를 발송합니다. 수신자가 채널 친구가 아닌 경우, 무료 수신거부 정보가 포함된 채널 메시지로 발송됩니다.
* **N**: 마케팅 수신 동의 유저 중 채널 친구를 제외하고 광고성 메시지를 발송합니다.
* **O**: 마케팅 수신 동의 유저 중 채널 친구인 유저를 대상으로 광고성 메시지를 발송합니다.

#### 비친구 메시지 발송 조건

비친구 대상 메시지 발송(타겟팅 M, N)은 아래 조건을 모두 만족해야 합니다.
