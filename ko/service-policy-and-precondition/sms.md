...
## 광고성 문자 발송 안내 { #information-about-080-call-blocking-service }

[[정보통신망 이용촉진 및 정보보호 등에 관한 법률](https://www.law.go.kr/%EB%B2%95%EB%A0%B9/%EC%A0%95%EB%B3%B4%ED%86%B5%EC%8B%A0%EB%A7%9D%EC%9D%B4%EC%9A%A9%EC%B4%89%EC%A7%84%EB%B0%8F%EC%A0%95%EB%B3%B4%EB%B3%B4%ED%98%B8%EB%93%B1%EC%97%90%EA%B4%80%ED%95%9C%EB%B2%95%EB%A5%A0)] 제50조에 따라 영리 목적의 광고성 정보 전송 시 수신자의 명시적인 사전 동의를 받아야 하며 발송 표기 의무사항을 반드시 준수해야 합니다.
...
* 광고성 정보가 시작되는 부분에 '(광고)' 표기
    ...
    * 제목이 있는 LMS/MMS인 경우 제목과 본문 모두 시작 부분에 '(광고)' 표시
...
## MMS 첨부 파일 크기에 따른 발송 속도 안내 { #delivery-speed-guide-according-to-mms-attachment-size }
...
## 문자 집합에 따른 발송 내용 안내 { #guidance-on-sending-content-according-to-character-set }
...
## 메시지 수신 결과 타임아웃 정책 { #message-received-result-timeout-policy }
