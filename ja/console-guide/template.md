...
#### ブランドメッセージテンプレート
ブランドメッセージテンプレートは、お知らせトークテンプレートとは異なり、審査プロセスがなく、作成・修正・削除を自由に行えます。

* 発信プロフィールを選択し、テンプレートを登録します。
...
* ボタンを登録できます。
    * サポートするボタンタイプ: Webリンク、アプリリンク、ボットキーワード、メッセージ転送、相談トーク転換、ボット転換、ビジネスフォーム、チャンネル追加
* クーポンを登録できます。
* イメージを添付するには、先にイメージを登録する必要があります。

#### 共用お知らせトークテンプレート
共用お知らせトークテンプレートは、カカオが直接作成・審査して公開したテンプレートです。すべての事業者が共通で使用でき、特定の発信プロフィールに帰属しません。カカオの審査がすでに完了した状態で提供されるため、別途審査リクエストなしにすぐ送信に使用できます。

* 自動登録
    * 発信プロフィールを登録すると、共用お知らせトークテンプレートが自動的に同期されてコンソールに表示されます。その後、カカオに新しい共用テンプレートが公開されると、定期的に自動同期されます。
    * 共用お知らせトークテンプレートは、**[カカオ]** カテゴリの下に自動的に分類されます。該当カテゴリはシステムが作成・管理するため、ユーザーが直接編集または削除することはできません。
* 使用制約
    * 共用お知らせトークテンプレートはカカオが管理するため、コンソールで編集または削除することはできません。
...
* 送信
    ...
    * 審査が完了した状態であるため、審査待ちなしにすぐ送信できます。
