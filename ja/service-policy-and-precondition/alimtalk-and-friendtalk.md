...
**Notification > Notification Hub > 利用ポリシーおよび事前設定のご案内 > お知らせトーク/ブランドメッセージ**
...
ブランドメッセージは、広告主のマーケティング受信同意（以下、マス同）会員を対象に、KakaoTalkチャンネルの友だち登録の有無にかかわらず、広告性メッセージを送信できるKakaoTalk Bizmessage商品です。

* チャンネルの友だちだけでなく、マス同ユーザーの中の非友だちにも広告性メッセージを送信できます。
...
ブランドメッセージはお知らせトークと同じ KakaoTalk 発信プロファイルを使用します。発信プロファイルの作成については、上記の **お知らせトーク > 発信プロファイルの作成** を参照してください。
...
顧客対象送信は、広告主のサービスユーザーを対象にメッセージを送信します。顧客対象送信を使用するには、事前に**顧客対象送信利用申請**を完了する必要があります。発信プロフィールに 080 受信拒否番号の登録が必要です。ターゲティングタイプに応じて、送信可能な対象が異なります。
...
友だち対象送信は、KakaoTalk チャンネルの友だち全員を対象にメッセージを送信します。080 受信拒否番号の登録は必要ありません。
...
* 080 受信拒否番号は、同一のカカオトークチャンネルの他の組織、他のプロジェクト、他のディーラーの発信プロフィール全体に一括適用されます。
...
* メッセージには、受信拒否および受信同意の撤回の意思を容易に行えるための措置と方法を具体的に明記する必要があります。
