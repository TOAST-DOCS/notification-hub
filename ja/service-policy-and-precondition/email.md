...
## 発信ドメインとDNS TXTレコードの登録 { #register-sending-domain-and-dns-txt-record }
...
## Gmail関連案内事項 { #gmail-related-guidelines }

<a id="enhanced-gmail-and-yahoos-email-receiving-standards"></a>
### GmailとYahooのメール受信基準強化 { #enhanced-gmail-and-yahoos-email-receiving-standards }
...
### Gmail閲覧済みのイベント収集不可案内 { #guide-about-being-not-possible-to-collect-viewed-event-with-gmail }
...
### Gmail低い評判(Low Reputation)問題 { #gmails-low-reputation-issue }
