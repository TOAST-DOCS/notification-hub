...
## サポートしている送信タイプ
- 下記の表の「統合 RCS 可否」が「O」の送信タイプは統合 RCS タイプであり、Android だけでなく iPhone 端末でも受信できます。（「X」の送信タイプは Android RCS タイプであり、Android 端末のみで受信できます。）
