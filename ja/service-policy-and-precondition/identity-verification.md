...
* Notification Hub を利用するには **Notification Hub** > **[本人認証]** で本人認証後に使用できます。（電気通信事業法関連告示遵守）
    * [電気通信事業法施行令第37条の7](https://www.law.go.kr/LSW//lsInfoP.do?lsId=004708&ancYnChk=0#0000)
* 事業者会員は本人認証を通じて Notification Hub を利用できます。個人会員は本人認証が制限されます。
* 本人認証は基本的に携帯電話本人認証と事業者登録証、在職証明書に対する書類審査が必要です。 
* 会員登録時に入力した名前と携帯電話番号が本人認証時に入力する情報と一致した場合、本人認証が承認されます。
* 事業者会員が作成した組織/プロジェクトに招待された NHN Cloud アカウント、または事業者会員が作成した組織に招待された IAM アカウントは、サービス利用のために本人認証を進行する必要があります。
    * 招待された NHN Cloud アカウント、IAM アカウントは本人認証承認時に会員タイプが事業者として区分されます。
* 在職証明書は **発行日が表記されており、社印が押印された書類** のみ可能です。在職証明書内の住民登録番号後の6桁は **必ずマスキング（隠蔽）処理** してください。例：000000-0\*\*\*\*\*\*
