...
## 2026. 06. 23.
### 機能追加
* [コンソール] お知らせトーク 共通テンプレート機能追加
    * 注文、決済、配送など、業種に関係なく汎用的に使用できるメッセージテンプレートを提供します。別途の審査プロセスなしに使用できます。
* [コンソール、API] ブランドメッセージチャンネルのリリース
    * カカオブランドメッセージの送信をサポートします。
    * 送信対象: 顧客企業会員向け（M、N、Oグループ）、チャンネル友だち向け（既存Iグループターゲティング送信）
    * 既存のKakaoTalk Bizmessage商品のブランドメッセージとの主な相違点:
        * Oグループターゲティング追加: 顧客企業の広告性受信同意会員のうちチャンネル友だち向け送信
        * 顧客企業会員向けメッセージはKakaoTalk 25.4.0以上のユーザーのみ受信可能
